...
function MainPage() {
  ...
  const scrollToSecondSection = () => {
    if (secondSectionRef.current) {
      window.scrollTo({
        top: secondSectionRef.current.offsetTop + 350,
        behavior: 'smooth'
      });
    }
  };
  ...
  return (
    <div>
      <section id="home" className='relative flex xl:mt-0 m-auto pr-10 max-w-[1920px]'>
        ...
        <div className='flex flex-col self-center justify-end items-end'>
          ...
          <p className='w-[42vw] max-w-[806px] mt-8 mb-4 font-golos-text text-[23px] font-normal leading-[27.6px] tracking-[-0.3px] text-right decoration-skip-ink-none sm:text-[18px] sm:leading-[22px] md:text-[20px] md:leading-[24px] lg:text-[21px] lg:leading-[25px] xl:text-[22px] xl:leading-[26px]'>
            InstaLikee — ведущая платформа для создания и просмотра коротких видео, обмена фотографиями и сообщениями. Наша миссия — вдохновлять пользователей на творчество и приносить радость.
          </p>
          <button
          ...
          <div className='absolute bottom-[-10px] left-[49.5%] cursor-pointer mt-10' onClick={scrollToSecondSection}>
            <CircleWithArrow />
          </div>
        </div>
      </section>
      <section id="about" ref={secondSectionRef} className='flex lg:flex-row md:flex-col xl:flex-row sm:flex-col pt-48 lg:mt-0 sm:mt-24 m-auto pr-10 pl-[8vw] max-w-[1920px] relative'>
      ...
      <section id="contact" className='mb-64 flex flex-row-reverse lg:flex-col md:flex-col xl:flex-row-reverse sm:flex-col pt-48 lg:mt-0 sm:mt-24 m-auto pr-10 pl-[8vw] max-w-[1920px] relative'>
        <div className='flex mr-14 mt-32 flex-col w-[50vw] sm:w-full sm:order-2'>
      ...
      <section id="legal" className='p-6 mb-64 flex flex-col items-center justify-center text-left'></section>
    ...
    <section ref={secondSectionRef} className='flex lg:flex-row mb-64 md:flex-col xl:flex-row sm:flex-col  pt-48 lg:mt-0 sm:mt-24 m-auto  max-w-[1920px] relative'>
      <div className='hidden xl:block w-[100%] h-[302px] pl-14 pt-4 relative bg-gradient-to-r from-yellow-500 to-[#FC01C6]'>
        <div className='flex flex-col self-center justify-start items-start lg:mr-[-150px] xl:mr-[-190px]'>
      ...
      <div className='block xl:hidden w-[100%] h-[302px] pl-14 pt-4 relative bg-gradient-to-r from-yellow-500 to-[#FC01C6]'>
        {/* <div className=' lg:justify-between lg:items-center lg:hidden'> */}
          <div className='flex flex-col self-center justify-start items-start lg:mr-[-150px] xl:mr-[-190px]'>
