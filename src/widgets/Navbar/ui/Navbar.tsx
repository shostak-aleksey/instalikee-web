    ...
    <header className="flex z-10 justify-between items-center w-full p-4 bg-white shadow-md">
      ...
      >
        ...
        <ul className="mt-10 space-y-4">
          <li className="px-4 py-2"><a href="#about">{t('About Us')}</a></li>
          <li className="px-4 py-2"><a href="#contact">{t('contact')}</a></li>
          <li className="px-4 py-2"><a href="#legal">{t('legal')}</a></li>
          <li className="px-4 py-2">
            ...
            <ul
              className={`absolute overflow-auto max-h-[310px] right-0 mt-2 w-48 bg-white border border-gray-200 z-11 rounded shadow-lg transition-opacity duration-300 ease-in-out ${
      ...
      <ul className="hidden lg:flex lg:justify-around xl:flex w-full">
        ...
        <div className="ml-auto">
          <li className="self-center font-bold text-lg leading-[25.2px] tracking-[-0.3px] mb-2">
            ...
            <ul
              className={`absolute overflow-auto max-h-[310px] right-0 mt-2 w-48 bg-white border z-10 border-gray-200 rounded shadow-lg transition-opacity duration-300 ease-in-out ${
                dropdownOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'
              }`}
            >
              <li className="px-4 py-2 hover:bg-gray-100" onClick={() => changeLanguage('ru')}>Русский</li>
